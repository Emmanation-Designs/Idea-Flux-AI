    ...
    >
      ...
      <div className="flex-1 overflow-y-auto px-2 space-y-1">
        ...
        {conversations.length === 0 ? (
          ...
          conversations.map((conv, idx) => (
            <div
              key={`sidebar-conv-${conv.id || 'new'}-${idx}-${conv.created_at}`}
      ...
      <div className="p-4 border-t border-zinc-200 dark:border-zinc-800 space-y-1">
        ...
        <button 
          ...
          className="w-full flex items-center gap-3 px-3 py-2 text-sm text-zinc-600 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-900 rounded-lg transition-colors"
        >
