export const Footer = ({ 
  ...
  return (
    <footer className="w-full py-3 md:py-6 px-4 border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 text-zinc-500 dark:text-zinc-400 text-[10px] md:text-xs text-center">
