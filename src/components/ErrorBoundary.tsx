        ...
        <div className="min-h-screen flex items-center justify-center p-4 bg-[#0A0A0A] text-white font-sans">
          <div className="max-w-md w-full bg-zinc-900/50 backdrop-blur-xl p-8 rounded-[2.5rem] border border-white/10 shadow-2xl text-center">
            ...
            <button
              ...
              className="w-full py-4 bg-white text-black rounded-2xl font-black text-xs uppercase tracking-widest hover:scale-[1.02] active:scale-[0.98] transition-all shadow-xl shadow-white/5 cursor-pointer"
            >
              Reload Application
            </button>
          </div>
